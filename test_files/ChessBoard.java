...
public class ChessBoard extends Board {
    ...
    protected void placePiece(String name, String color, String location) {
        int[] gridLocation = parseLocation(location);
        switch (name) {
            case "Rook":
                grid[gridLocation[0]][gridLocation[1]] = new Rook(color);
                break;
            case "Knight":
                grid[gridLocation[0]][gridLocation[1]] = new Knight(color);
                break;
            case "Bishop":
                grid[gridLocation[0]][gridLocation[1]] = new Bishop(color);
                break;
            case "Queen":
                grid[gridLocation[0]][gridLocation[1]] = new Queen(color);
                break;
            case "King":
                grid[gridLocation[0]][gridLocation[1]] = new King(color);
                break;
            case "Pawn":
                grid[gridLocation[0]][gridLocation[1]] = new Pawn(color);
                break;
        }
    }
